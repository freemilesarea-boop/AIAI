...
The generation-domain models use dialect-portable types, so the same
models run on SQLite here and PostgreSQL in production (migrations are
verified against real PostgreSQL in CI and locally).
"""
