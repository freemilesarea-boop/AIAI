"""Fixtures for dataset intelligence.

The helpers and fixtures live in ``intelligence_fixtures.py`` rather than here.
...
from intelligence_fixtures import (  # noqa: F401
    biased_manifest,
)
