  ...
  return (
    ...
    >
      ...
      <Section id="generated" title="제8조 (생성 결과물의 이용)">
        <p>
          BOORDA는 서비스 이용조건에 따라 생성 결과물을 사용할 수 있는{" "}
          <strong>계약상 이용 권한</strong>을 제공합니다. 다만 생성 결과물의 저작권 성립
          여부 및 법적 보호 범위는 인간의 창작적 기여 정도, 관련 법령 및 관할에 따라 달라질
          수 있습니다.
        </p>
        <p>
          상업적 이용 가능 여부는 이용자의 요금제에 따라 다르며, 서비스 내 요금제 화면에
          표시된 범위를 따릅니다. 위 이용 권한은 회사가 계약으로 부여하는 권한이며, 저작권의
          성립 또는 귀속을 확정하는 것이 아닙니다.
        </p>
